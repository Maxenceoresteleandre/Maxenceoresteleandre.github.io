...
func set_camera_pos(new_pos : Vector2) -> void:
	camera_pos = new_pos
	if Engine.editor_hint:
		update()
...
func _on_CameraAnchor_body_entered(body : Node2D) -> void:
